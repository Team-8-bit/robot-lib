...
fun Pose2d(x: Double, y: Double, rotation: Angle) = Pose2d(x, y, rotation.asRotation2d)
...
fun Translation3d(x: Length, y: Length, z: Length) = Translation3d(x.inMeters, y.inMeters, z.inMeters)